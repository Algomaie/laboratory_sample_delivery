...
class SplashScreenState extends State<SplashScreen>
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: ScaleTransition(
            scale: animation,
            child: Center(
              child: DynamicLogo(width: 300, height: 300),
            )),
      ),
    );
  }
  ...
  initSetting() async {
    ...
    await licenseController.checkLocalLicense();
    
    if (!licenseController.isLicensed.value) {
      await navigateToRoute(RouteHelper.getLicenseRoute());
      return;
    }
