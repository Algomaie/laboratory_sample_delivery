...
class _RegisterScreenState extends State<RegisterScreen> {
                          ...
                          Container(
                            ...
                            child: Column(children: [
                              ...
                              CustomTextField(
                                ...
                                border: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(5),
                                  borderSide: BorderSide(color: Theme.of(context).primaryColor, style: BorderStyle.solid, width: 10),
                                ),
                                activeBorder: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(5),
                                  borderSide: BorderSide(color: Theme.of(context).primaryColor, style: BorderStyle.solid, width: 2),
                                ),
                                enabledBorder: OutlineInputBorder(
                                  borderRadius: BorderRadius.circular(5),
                                  borderSide: BorderSide(color: Colors.black, style: BorderStyle.solid, width: 1.7),
                                ),
                              ),
                              const SizedBox(
                                height: 10,
                              ...
                              if (_accountType == 'عميل') ...[
                                CustomTextField(
                                  hintText: 'رقم السجل الطبي',
  ...
  void _register(AuthController authController) async {
    ...
    String _medicalRecord = _medicalRecordController.text.trim();
    String _vehicleNum = _vehicleNumController.text.trim();
    ...
    if (_firstName.isEmpty) {
      ...
      showCustomSnackBar('الرجاء إدخال رقم الهاتف');
    } else if (_address.isEmpty) {
      showCustomSnackBar('الرجاء إدخال العنوان');
    } else if (_accountType == 'عميل' && _medicalRecord.isEmpty) {
      showCustomSnackBar('الرجاء إدخال رقم السجل الطبي');
    } else if (_accountType == 'موصل' && _vehicleNum.isEmpty) {
      showCustomSnackBar('الرجاء إدخال رقم المركبة');
    } else {
      ...
      authController
          .userRegister(
            ...
            phone: _phone,
            address: _address,
            medicalRecord: _accountType == 'عميل' ? _medicalRecord : null,
            vehicleNum: _accountType == 'موصل' ? _vehicleNum : null,
          )
          .then((status) async {});
    }
  }
