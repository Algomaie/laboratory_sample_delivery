...
class LocalizationController extends GetxController implements GetxService {
  ...
  void loadCurrentLanguage() async {
    _locale = Locale(
        storage.getString(AppConstants.LANGUAGE_CODE) ??
            AppConstants.languages[0].languageCode!,
        storage.getString(AppConstants.COUNTRY_CODE) ??
            AppConstants.languages[0].countryCode);
  ...
  void saveLanguage(Locale locale) async {
    storage.setString(AppConstants.LANGUAGE_CODE, locale.languageCode);
    storage.setString(AppConstants.COUNTRY_CODE, locale.countryCode!);
  }
